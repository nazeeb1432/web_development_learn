...
app.post("/submit", (req, res) => {
  ...
  let randomNumber1=getRandomNumber(0,adj.length-1);
  let randomNumber2=getRandomNumber(0,noun.length-1);

  var bandAdj=adj[randomNumber1];
  var bandNoun=noun[randomNumber2];

  console.log(bandAdj+" "+bandNoun);

  res.render('index.ejs', {bandAdj: bandAdj, bandNoun: bandNoun});
